(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const m of s.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&e(m)}).observe(document,{childList:!0,subtree:!0});function o(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function e(a){if(a.ep)return;a.ep=!0;const s=o(a);fetch(a.href,s)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=r(e);fetch(e.href,a)}})();const V="faro_pets_data_v4",_=[{id:"pet-1",name:"Thor",type:"dog",breed:"Golden Retriever",status:"lost",gender:"Macho",color:"Dourado claro",reward:"R$ 1.500",date:"08/08/2026",time:"14:30",city:"São Paulo",state:"SP",neighborhood:"Pinheiros / Vila Madalena",location:"Rua Fradique Coutinho próximo à Praça Benedito Calixto",lat:-23.5587,lng:-46.6853,description:"Thor usava uma coleira vermelha com plaquinha de identificação. É extremamente sociável, dócil, mas pode estar assustado pelo barulho de carros.",photo:"https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=800&q=80",contactName:"Mariana Souza",contactPhone:"(11) 98765-4321",microchip:"982000341829102",urgent:!0},{id:"pet-2",name:"Luna",type:"cat",breed:"Siamês Mestiço",status:"lost",gender:"Fêmea",color:"Bege com extremidades escuras e olhos azuis",reward:"R$ 800",date:"07/08/2026",time:"21:00",city:"São Paulo",state:"SP",neighborhood:"Moema",location:"Alameda dos Maracatins, perto da Av. Ibirapuera",lat:-23.6041,lng:-46.6625,description:"Luna fugiu pela varanda do apartamento. Tem olhos azuis intensos e uma pequena falha de pelo na orelha esquerda.",photo:"https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=800&q=80",contactName:"Carlos Eduardo",contactPhone:"(11) 97654-3210",microchip:"Não informado",urgent:!0},{id:"pet-3",name:"Malu (Resgatada)",type:"dog",breed:"Vira-lata (SRD)",status:"found",gender:"Fêmea",color:"Caramelo com peito branco",reward:"Sem recompensa",date:"09/08/2026",time:"08:15",city:"São Paulo",state:"SP",neighborhood:"Itaim Bibi",location:"Resgatada na Rua Joaquim Floriano perto do Parque Povo",lat:-23.5852,lng:-46.6775,description:"Cadela vira-lata caramelo muito carinhosa encontrada perambulando pela calçada. Está sob meus cuidados temporários no veterinário local.",photo:"https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?auto=format&fit=crop&w=800&q=80",contactName:"Dra. Patricia Lima",contactPhone:"(11) 99123-4567",microchip:"Verificando em clínica",urgent:!1},{id:"pet-4",name:"Apollo",type:"dog",breed:"Bulldog Francês",status:"lost",gender:"Macho",color:"Preto e Branco (Tigrado)",reward:"R$ 2.000",date:"06/08/2026",time:"18:45",city:"Rio de Janeiro",state:"RJ",neighborhood:"Copacabana / Ipanema",location:"Posto 5 na Av. Atlântica",lat:-22.9772,lng:-43.1903,description:"Apollo necessita de medicação contínua para problemas respiratórios. Coleira peitoral azul marinho.",photo:"https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?auto=format&fit=crop&w=800&q=80",contactName:"Fernando Alvares",contactPhone:"(21) 98111-2233",microchip:"9851410098231",urgent:!0},{id:"pet-5",name:"Gato Encontrado (Cinza)",type:"cat",breed:"Sem Raça Definida",status:"found",gender:"Macho",color:"Cinza rajado / Tom Tabby",reward:"N/A",date:"08/08/2026",time:"19:30",city:"Campinas",state:"SP",neighborhood:"Cambuí",location:"Encontrado no estacionamento do condomínio na Rua Maria Monteiro",lat:-22.8984,lng:-47.0542,description:"Gato castrado, limpo e bem cuidado. Parecia recém-perdido. Está acolhido na garagem.",photo:"https://images.unsplash.com/photo-1573865526739-10659fec78a5?auto=format&fit=crop&w=800&q=80",contactName:"Beatriz Ramos",contactPhone:"(19) 99887-6655",microchip:"Não possui",urgent:!1},{id:"pet-6",name:"Pipoca",type:"dog",breed:"Poodle Toy",status:"lost",gender:"Fêmea",color:"Branco neve",reward:"R$ 1.000",date:"05/08/2026",time:"11:00",city:"Belo Horizonte",state:"MG",neighborhood:"Savassi",location:"Próximo à Praça da Savassi",lat:-19.9387,lng:-43.9332,description:"Poodle idosa com dificuldade de visão. Atende pelo nome de Pipoca.",photo:"https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80",contactName:"Clara Mendes",contactPhone:"(31) 98844-3322",microchip:"Sim",urgent:!1}],ee=[{id:"ong-sp-ps-1",name:"Pet Searchers - Central de Apoio & Busca",city:"Santo André",state:"SP",phone:"(11) 98000-8442",whatsapp:"5511980008442",instagram:"petsearchersoficial",address:"Praça Atlântica Valparaíso, Santo André - SP",lat:-23.662,lng:-46.541,shelteredCount:300,services:["Central de Buscas","Divulgação Estratégica","Suporte a Tutores"],website:"https://pet-searchers.com"},{id:"ong-sp-1",name:"Confraria dos Miados e Latidos",city:"São Paulo",state:"SP",phone:"(11) 4327-6330",whatsapp:"551143276330",instagram:"cmiadoselatidos",address:"Av. Jabaquara, 1200 - Mirandópolis, São Paulo - SP",lat:-23.605,lng:-46.638,shelteredCount:180,services:["Adoção Responsável","Leitura de Microchip","Feira de Reencontros"],website:"https://miadoselatidos.org.br"},{id:"ong-sp-2",name:"ONG Canto da Terra",city:"São Paulo",state:"SP",phone:"(11) 97055-3947",whatsapp:"5511970553947",instagram:"ongcantodaterra",address:"Rua Domingos de Morais, 2100 - Vila Mariana, São Paulo - SP",lat:-23.59,lng:-46.635,shelteredCount:120,services:["Resgate de Animais","Triagem de Perdidos","Acolhimento"],website:"https://cantodaterra.org.br"},{id:"ong-sp-3",name:"Instituto Caramelo",city:"São Paulo",state:"SP",phone:"(11) 3034-5678",whatsapp:"5511987654321",instagram:"institutocaramelo",address:"Av. Brigadeiro Faria Lima, 2200 - Pinheiros, São Paulo - SP",lat:-23.5705,lng:-46.6872,shelteredCount:350,services:["Hospital Veterinário Comunitário","Resgate","Reencontro"],website:"https://institutocaramelo.org"},{id:"ong-sp-4",name:"Ampara Animal",city:"São Paulo",state:"SP",phone:"(11) 3885-9988",whatsapp:"5511938859988",instagram:"amparanimal",address:"Av. Paulista, 1000 - Bela Vista, São Paulo - SP",lat:-23.5615,lng:-46.656,shelteredCount:520,services:["Rede Nacional de Proteção","Políticas Públicas","Castração"],website:"https://amparanimal.org.br"},{id:"ong-sp-5",name:"UIPA (União Internacional Protetora dos Animais)",city:"São Paulo",state:"SP",phone:"(11) 3228-1462",whatsapp:"5511932281462",instagram:"uipaoficial",address:"Av. Presidente Castelo Branco, 3200 - Canindé, São Paulo - SP",lat:-23.522,lng:-46.621,shelteredCount:480,services:["Hospital Veterinário Popular","Abrigo Histórico","Resgates"],website:"https://uipa.org.br"},{id:"ong-sp-6",name:"ONG Cão Sem Dono",city:"Santo André",state:"SP",phone:"(11) 97543-2100",whatsapp:"5511975432100",instagram:"caosemdonooficial",address:"Rua das Figueiras, 450 - Bairro Jardim, Santo André - SP",lat:-23.655,lng:-46.538,shelteredCount:420,services:["Resgate e Acolhimento","Clínica Comunitária","Feira de Adoção"],website:"https://caosemdono.org.br"},{id:"ong-sp-7",name:"AAAC (Associação Protetora de Animais de Campinas)",city:"Campinas",state:"SP",phone:"(19) 3251-1234",whatsapp:"5519998876655",instagram:"aaac.campinas",address:"Av. Barão de Itapura, 1500 - Guanabara, Campinas - SP",lat:-22.89,lng:-47.06,shelteredCount:260,services:["Acolhimento Temporário","Leitor de Microchip"],website:"https://aaac.org.br"},{id:"ong-sp-8",name:"Amigos Felinos (Especializada em Gatos)",city:"Santos",state:"SP",phone:"(13) 99712-3344",whatsapp:"5513997123344",instagram:"amigosfelinossantos",address:"Av. Ana Costa, 300 - Gonzaga, Santos - SP",lat:-23.955,lng:-46.33,shelteredCount:140,services:["Resgate Felino (CED)","Castração","Adoção Responsável"],website:"https://amigosfelinos.org.br"},{id:"ong-sp-9",name:"Rancho dos Gnomos (Santuário de Animais)",city:"Cotia",state:"SP",phone:"(11) 4614-2323",whatsapp:"5511946142323",instagram:"ranchodosgnomos",address:"Estrada do Caucaia, Cotia - SP",lat:-23.6,lng:-46.92,shelteredCount:310,services:["Santuário e Acolhimento de Alta Vulnerabilidade"],website:"https://ranchodosgnomos.org.br"},{id:"ong-sp-10",name:"Proteção Animal de Barueri",city:"Barueri",state:"SP",phone:"(11) 4199-1500",whatsapp:"5511941991500",instagram:"protecaoanimalbarueri",address:"Al. Araguaia, Alphaville, Barueri - SP",lat:-23.51,lng:-46.87,shelteredCount:190,services:["Acolhimento Municipal","Triagem de Microchip"],website:"https://barueri.sp.gov.br"},{id:"ong-sp-11",name:"Associação Protetora dos Animais de Sorocaba",city:"Sorocaba",state:"SP",phone:"(15) 3232-1122",whatsapp:"5515998877112",instagram:"spasorocaba",address:"Av. Afonso Vergueiro, Sorocaba - SP",lat:-23.5,lng:-47.45,shelteredCount:220,services:["Abrigo Regional","Feiras de Reencontro"],website:"https://spasorocaba.org.br"},{id:"ong-sp-12",name:"Focinhos Carentes de Ribeirão Preto",city:"Ribeirão Preto",state:"SP",phone:"(16) 99112-3344",whatsapp:"5516991123344",instagram:"focinhosrp",address:"Av. Nove de Julho, Ribeirão Preto - SP",lat:-21.17,lng:-47.81,shelteredCount:180,services:["Resgate e Castração","Doações e Feiras"],website:"https://focinhosrp.com.br"},{id:"ong-rj-1",name:"SUIPA (Sociedade União Internacional Protetora dos Animais)",city:"Rio de Janeiro",state:"RJ",phone:"(21) 3297-8775",whatsapp:"5521984586653",instagram:"suipa",address:"Av. Dom Hélder Câmara, 1801 - Benfica, Rio de Janeiro - RJ",lat:-22.8895,lng:-43.2452,shelteredCount:650,services:["Atendimento 24h","Acolhimento de Resgatados","Reencontro"],website:"https://suipa.org.br"},{id:"ong-rj-2",name:"ONG G.A.R.R.A",city:"Rio de Janeiro",state:"RJ",phone:"(21) 98024-1232",whatsapp:"5521980241232",instagram:"garrabicho",address:"Rua Visconde de Pirajá, 350 - Ipanema, Rio de Janeiro - RJ",lat:-22.984,lng:-43.2,shelteredCount:160,services:["Resgate de Animais Feridos","Encaminhamento Lar Temporário"],website:"https://onggarra.com"},{id:"ong-rj-3",name:"Paraíso dos Focinhos",city:"Niterói",state:"RJ",phone:"(21) 99876-4321",whatsapp:"5521998764321",instagram:"paraisodosfocinhos",address:"Estrada Francisco da Cruz Nunes, 2000 - Itaipu, Niterói - RJ",lat:-22.95,lng:-43.03,shelteredCount:290,services:["Reabilitação Intensiva","Adoção e Reagrupamento"],website:"https://paraisodosfocinhos.com.br"},{id:"ong-rj-4",name:"Toca dos Gatinhos RJ",city:"Rio de Janeiro",state:"RJ",phone:"(21) 98777-1122",whatsapp:"5521987771122",instagram:"tocadosgatinhosrj",address:"Bairro Botafogo, Rio de Janeiro - RJ",lat:-22.95,lng:-43.18,shelteredCount:110,services:["Abrigo para Felinos","Testes FIV/FELV","Adoções"],website:"https://tocadosgatinhosrj.org"},{id:"ong-rj-5",name:"Dog's Heaven Petrópolis",city:"Petrópolis",state:"RJ",phone:"(24) 99266-3355",whatsapp:"5524992663355",instagram:"dogsheavenpetropolis",address:"Estrada União e Indústria, Itaipava, Petrópolis - RJ",lat:-22.42,lng:-43.13,shelteredCount:300,services:["Resgate na Região Serrana","Reabilitação de Cães"],website:"https://dogsheaven.org.br"},{id:"ong-mg-1",name:"Projeto Casa Mia (Gatos)",city:"Belo Horizonte",state:"MG",phone:"(31) 99653-1454",whatsapp:"5531996531454",instagram:"casamiabh",address:"Rua Sergipe, 1200 - Savassi, Belo Horizonte - MG",lat:-19.932,lng:-43.935,shelteredCount:110,services:["Acolhimento de Gatos","Checagem de Microchip","Adoção"],website:"https://casamiabh.com.br"},{id:"ong-mg-2",name:"Associação Cãoviver",city:"Contagem",state:"MG",phone:"(31) 3392-1234",whatsapp:"5531988884433",instagram:"caoviver",address:"Av. João César de Oliveira, 3000 - Eldorado, Contagem - MG",lat:-19.932,lng:-44.05,shelteredCount:230,services:["Reabilitação de Cães","Checagem de Desaparecidos"],website:"https://caoviver.com.br"},{id:"ong-mg-3",name:"Rock Bicho BH",city:"Belo Horizonte",state:"MG",phone:"(31) 98711-2244",whatsapp:"5531987112244",instagram:"rockbichobh",address:"Bairro Anchieta, Belo Horizonte - MG",lat:-19.95,lng:-43.92,shelteredCount:175,services:["Resgate Urbano","Castração a Baixo Custo"],website:"https://rockbicho.org.br"},{id:"ong-mg-4",name:"APA Uberlândia (Associação de Proteção Animal)",city:"Uberlândia",state:"MG",phone:"(34) 99812-4411",whatsapp:"5534998124411",instagram:"apauberlandia",address:"Av. Rondon Pacheco, Uberlândia - MG",lat:-18.91,lng:-48.27,shelteredCount:210,services:["Acolhimento no Triângulo Mineiro","Castração"],website:"https://apauberlandia.org.br"},{id:"ong-rs-1",name:"USAV - Unidade de Saúde Animal de Porto Alegre",city:"Porto Alegre",state:"RS",phone:"(51) 3289-5400",whatsapp:"5551981144527",instagram:"usavportoalegre",address:"Estrada das Quirinas, 90 - Lomba do Pinheiro, Porto Alegre - RS",lat:-30.08,lng:-51.12,shelteredCount:500,services:["Centro de Resgate Municipal","Acolhimento pós-Enchentes"],website:"http://prefeitura.poa.br/usav"},{id:"ong-rs-2",name:"Rede de Abrigos Pet Searchers RS",city:"Porto Alegre",state:"RS",phone:"(51) 99882-1100",whatsapp:"5551998821100",instagram:"petsrs_abrigos",address:"Bairro Petrópolis, Porto Alegre - RS",lat:-30.035,lng:-51.18,shelteredCount:650,services:["Triagem Centralizada de Desaparecidos","Alerta Metropolitano"],website:"https://pet-searchers.com"},{id:"ong-rs-3",name:"SOS Animais Canoas",city:"Canoas",state:"RS",phone:"(51) 99711-2233",whatsapp:"5551997112233",instagram:"sosanimaiscanoas",address:"Av. Getúlio Vargas, Canoas - RS",lat:-29.91,lng:-51.18,shelteredCount:380,services:["Resgate e Reagrupamento Familiar","Lar Temporário"],website:"https://sosanimaiscanoas.org"},{id:"ong-rs-4",name:"SOAMA Caxias do Sul",city:"Caxias do Sul",state:"RS",phone:"(54) 99122-4455",whatsapp:"5554991224455",instagram:"soamacaxias",address:"Bairro Ana Rech, Caxias do Sul - RS",lat:-29.16,lng:-51.17,shelteredCount:450,services:["Abrigo de Cães e Gatos na Serra Gaúcha","Adoção"],website:"https://soama.org.br"},{id:"ong-rs-5",name:"Protetores de Pelotas",city:"Pelotas",state:"RS",phone:"(53) 99877-6611",whatsapp:"5553998776611",instagram:"protetorespelotas",address:"Bairro Laranjal, Pelotas - RS",lat:-31.76,lng:-52.34,shelteredCount:220,services:["Acolhimento no Sul do RS","Atendimento de Emergência"],website:"https://protetorespelotas.com.br"},{id:"ong-rs-6",name:"Amigos dos Animais de Viamão",city:"Viamão",state:"RS",phone:"(51) 99655-3322",whatsapp:"5551996553322",instagram:"amigosviamao",address:"Bairro Cecília, Viamão - RS",lat:-30.08,lng:-51.02,shelteredCount:280,services:["Santuário e Triagem de Perdidos"],website:"https://amigosviamao.org"},{id:"ong-ba-1",name:"União de Proteção Animal da Bahia (UPABA)",city:"Salvador",state:"BA",phone:"(71) 98877-6655",whatsapp:"5571988776655",instagram:"uniaodeprotecaoanimalsalvador",address:"Av. Sete de Setembro, 1500 - Vitória, Salvador - BA",lat:-12.98,lng:-38.52,shelteredCount:210,services:["Resgate Urbano","Acolhimento","Feiras de Reencontro"],website:"https://upaba.org.br"},{id:"ong-ba-2",name:"Lar Dona Zélia",city:"Salvador",state:"BA",phone:"(71) 99123-8899",whatsapp:"5571991238899",instagram:"ajudeolardonazelia",address:"Bairro Itapuã, Salvador - BA",lat:-12.93,lng:-38.35,shelteredCount:140,services:["Abrigo Comunitário","Triagem de Cães Perdidos"],website:"https://lardonazelia.com.br"},{id:"ong-ba-3",name:"Planeta dos Bichos Ilhéus",city:"Ilhéus",state:"BA",phone:"(73) 99911-2244",whatsapp:"5573999112244",instagram:"planetadosbichosilheus",address:"Av. Soares Lopes, Ilhéus - BA",lat:-14.79,lng:-39.03,shelteredCount:130,services:["Resgate Litoral Sul da Bahia","Adoção"],website:"https://planetadosbichos.org"},{id:"ong-pe-1",name:"ONG Severino Chaves (Vovó dos Animais)",city:"Recife",state:"PE",phone:"(81) 98694-0357",whatsapp:"5581986940357",instagram:"vovodosanimais",address:"Av. Boa Viagem, 2400 - Boa Viagem, Recife - PE",lat:-8.12,lng:-34.89,shelteredCount:195,services:["Resgate e Acolhimento","Mutirão de Castração"],website:"https://vovodosanimais.org.br"},{id:"ong-ce-1",name:"ONG Abrace (Proteção Animal Fortaleza)",city:"Fortaleza",state:"CE",phone:"(85) 99765-4321",whatsapp:"5585997654321",instagram:"ong.abrace",address:"Av. Beira Mar, 3100 - Meireles, Fortaleza - CE",lat:-3.725,lng:-38.49,shelteredCount:175,services:["Resgate de Cães e Gatos","Feiras de Adoção"],website:"https://abracefortaleza.org"},{id:"ong-ce-2",name:"Adote um Bigode",city:"Fortaleza",state:"CE",phone:"(85) 98811-2233",whatsapp:"5585988112233",instagram:"adoteumbigodece",address:"Bairro Aldeota, Fortaleza - CE",lat:-3.735,lng:-38.5,shelteredCount:90,services:["Especializada em Felinos","Checagem de Microchips"],website:"https://adoteumbigode.org"},{id:"ong-ce-3",name:"Abrigo São Lázaro",city:"Fortaleza",state:"CE",phone:"(85) 98722-1100",whatsapp:"5585987221100",instagram:"abrigosaolazaro",address:"Bairro Passaré, Fortaleza - CE",lat:-3.8,lng:-38.53,shelteredCount:400,services:["Maior Abrigo do Ceará","Triagem de Perdidos"],website:"https://abrigosaolazaro.org.br"},{id:"ong-go-1",name:"Grupo Miau Auau",city:"Goiânia",state:"GO",phone:"(62) 99127-4946",whatsapp:"5562991274946",instagram:"grupomiauauau",address:"Setor Bueno, Goiânia - GO",lat:-16.695,lng:-49.26,shelteredCount:160,services:["Resgate","Eventos de Adoção e Reagrupamento"],website:"https://miauauau.org.br"},{id:"ong-go-2",name:"ASPAAN (Associação Protetora e Amiga dos Animais)",city:"Goiânia",state:"GO",phone:"(62) 3201-1200",whatsapp:"5562988771122",instagram:"aspaangoiania",address:"Setor Oeste, Goiânia - GO",lat:-16.68,lng:-49.27,shelteredCount:220,services:["Abrigo de Cães","Cadastro de Animais Perdidos"],website:"https://aspaan.org.br"},{id:"ong-df-1",name:"Projeto Abrigo dos Animais DF",city:"Brasília",state:"DF",phone:"(61) 99876-1234",whatsapp:"5561998761234",instagram:"abrigodosanimaisdf",address:"Asa Norte - Brasília - DF",lat:-15.78,lng:-47.88,shelteredCount:240,services:["Atendimento Emergencial","Triagem de Microchip"],website:"https://abrigodf.org.br"},{id:"ong-df-2",name:"ProAnima Brasília",city:"Brasília",state:"DF",phone:"(61) 98111-9988",whatsapp:"5561981119988",instagram:"proanimadf",address:"Asa Sul - Brasília - DF",lat:-15.8,lng:-47.89,shelteredCount:180,services:["Políticas Públicas e Resgates","Reagrupamento"],website:"https://proanima.org.br"},{id:"ong-pr-1",name:"Grupo Força Animal",city:"Curitiba",state:"PR",phone:"(41) 99686-2884",whatsapp:"5541997779779",instagram:"grupoforcaanimal",address:"Atendimento Região de Curitiba - PR",lat:-25.4284,lng:-49.2733,shelteredCount:190,services:["Emergência 24h","Resgate de Animais","Reencontro"],website:"https://grupoforcaanimal.ong.br"},{id:"ong-pr-2",name:"SPAC - Sociedade Protetora dos Animais de Curitiba",city:"Curitiba",state:"PR",phone:"(41) 98802-5232",whatsapp:"5541988025232",instagram:"spac_curitiba",address:"Estrada Nova de Colombo, 5500 - Santa Cândida, Curitiba - PR",lat:-25.38,lng:-49.23,shelteredCount:300,services:["Hospital Veterinário Comunitário","Abrigo"],website:"https://spac.org.br"},{id:"ong-pr-3",name:"SOCPAM (Sociedade Protetora dos Animais de Maringá)",city:"Maringá",state:"PR",phone:"(44) 99811-2233",whatsapp:"5544998112233",instagram:"socpam.maringa",address:"Av. Brasil, Maringá - PR",lat:-23.42,lng:-51.93,shelteredCount:160,services:["Resgate no Norte do Paraná","Adoções"],website:"https://socpam.org.br"},{id:"ong-sc-1",name:"Dibea Florianópolis",city:"Florianópolis",state:"SC",phone:"(48) 3237-6890",whatsapp:"5548988332211",instagram:"dibeafloipa",address:"Rod. SC-401, 1500 - Itacorubi, Florianópolis - SC",lat:-27.575,lng:-48.51,shelteredCount:280,services:["Diretoria de Bem-Estar Animal","Adoções","Castração"],website:"https://dibeafloipa.sc.gov.br"},{id:"ong-sc-2",name:"Frada Joinville",city:"Joinville",state:"SC",phone:"(47) 99712-4411",whatsapp:"5547997124411",instagram:"fradajoinville",address:"Bairro América, Joinville - SC",lat:-26.3,lng:-48.84,shelteredCount:190,services:["Resgate Norte Catarinense","Feira de Reencontro"],website:"https://frada.org.br"},{id:"ong-es-1",name:"Patas e Focinhos Vitória",city:"Vitória",state:"ES",phone:"(27) 99881-7766",whatsapp:"5527998817766",instagram:"patasefocinhosvitoria",address:"Enseada do Suá, Vitória - ES",lat:-20.315,lng:-40.295,shelteredCount:130,services:["Resgate Marítimo e Urbano","Acolhimento"],website:"https://patasefocinhoses.org"},{id:"ong-am-1",name:"Anjos de Rua Manaus",city:"Manaus",state:"AM",phone:"(92) 99136-3600",whatsapp:"5592991363600",instagram:"anjosderuamanaus",address:"Bairro Adrianópolis, Manaus - AM",lat:-3.1,lng:-60.01,shelteredCount:150,services:["Resgate na Amazônia","Castração e Reencontro"],website:"https://anjosderuamanaus.org"},{id:"ong-pa-1",name:"SEPDA Belém - Proteção Animal",city:"Belém",state:"PA",phone:"(91) 99334-3367",whatsapp:"5591993343367",instagram:"sepdabelem",address:"Av. Nazaré, 800 - Nazaré, Belém - PA",lat:-1.45,lng:-48.48,shelteredCount:200,services:["Atendimento Municipal","Resgate e Zoonoses"],website:"https://sepda.belem.pa.gov.br"},{id:"ong-ma-1",name:"Amparo Animal São Luís",city:"São Luís",state:"MA",phone:"(98) 98722-3344",whatsapp:"5598987223344",instagram:"amparoanimalslz",address:"Bairro Renascença, São Luís - MA",lat:-2.51,lng:-44.28,shelteredCount:165,services:["Abrigo Temporário","Reencontros de Animais"],website:"https://amparoanimalslz.org"},{id:"ong-ap-1",name:"UPAC - União de Proteção Animal Costelinha",city:"Macapá",state:"AP",phone:"(96) 99122-3344",whatsapp:"5596991223344",instagram:"upacmacapa",address:"Bairro Trem, Macapá - AP",lat:.03,lng:-51.07,shelteredCount:140,services:["Resgate e Acolhimento no Amapá","Castração"],website:"https://upacamapa.org"},{id:"ong-ap-2",name:"Instituto Mapinguari",city:"Macapá",state:"AP",phone:"(96) 98811-2233",whatsapp:"5596988112233",instagram:"institutomapinguari",address:"Bairro Central, Macapá - AP",lat:.04,lng:-51.06,shelteredCount:95,services:["Defesa Animal e Resgate de Silvestres/Domésticos"],website:"https://institutomapinguari.org.br"},{id:"ong-al-1",name:"Grupo Pata Amada Maceió",city:"Maceió",state:"AL",phone:"(82) 99611-3322",whatsapp:"5582996113322",instagram:"pataamadamaceio",address:"Orla de Pajuçara, Maceió - AL",lat:-9.66,lng:-35.7,shelteredCount:165,services:["Resgate Praiano","Feiras de Reencontro"],website:"https://pataamada.org"},{id:"ong-al-2",name:"AHPAR - Proteção Animal Arapiraca",city:"Arapiraca",state:"AL",phone:"(82) 98822-4455",whatsapp:"5582988224455",instagram:"ahpararapiraca",address:"Centro, Arapiraca - AL",lat:-9.75,lng:-36.66,shelteredCount:120,services:["Abrigo Agreste Alagoano","Triagem de Perdidos"],website:"https://ahpar.org.br"},{id:"ong-rn-1",name:"ONG Ampara Mossoró",city:"Mossoró",state:"RN",phone:"(84) 99822-4433",whatsapp:"5584998224433",instagram:"amparamossoro",address:"Bairro Nova Betânia, Mossoró - RN",lat:-5.18,lng:-37.34,shelteredCount:135,services:["Resgate no Oeste Potiguar","Adoção"],website:"https://amparamossoro.org"},{id:"ong-ms-1",name:"Abrigo dos Bichos Campo Grande",city:"Campo Grande",state:"MS",phone:"(67) 99233-4455",whatsapp:"5567992334455",instagram:"abrigodosbichoscg",address:"Bairro Jardim dos Estados, Campo Grande - MS",lat:-20.46,lng:-54.6,shelteredCount:190,services:["Resgate no Pantanal e Capital","Feira de Adoção"],website:"https://abrigodosbichos.org.br"},{id:"ong-mt-1",name:"APA Cuiabá (Associação Protetora dos Animais)",city:"Cuiabá",state:"MT",phone:"(65) 99655-1122",whatsapp:"5565996551122",instagram:"apacuiaba",address:"Av. Historiador Rubens de Mendonça, Cuiabá - MT",lat:-15.59,lng:-56.09,shelteredCount:210,services:["Acolhimento Comunitário","Castração Popular"],website:"https://apacuiaba.org.br"},{id:"ong-pb-1",name:"Haras do Bem João Pessoa",city:"João Pessoa",state:"PB",phone:"(83) 98711-5566",whatsapp:"5583987115566",instagram:"harasdobemjp",address:"Bairro Tambaú, João Pessoa - PB",lat:-7.11,lng:-34.82,shelteredCount:135,services:["Resgate de Cães e Equinos","Reencontros"],website:"https://harasdobem.org"},{id:"ong-pi-1",name:"APIPA Teresina",city:"Teresina",state:"PI",phone:"(86) 99433-2211",whatsapp:"5586994332211",instagram:"apipateresina",address:"Av. Frei Serafim, Teresina - PI",lat:-5.08,lng:-42.8,shelteredCount:180,services:["Abrigo Central de Teresina","Castração"],website:"https://apipapiauí.org.br"},{id:"ong-se-1",name:"Adota Aracaju",city:"Aracaju",state:"SE",phone:"(79) 99877-3322",whatsapp:"5579998773322",instagram:"adotaaracaju",address:"Av. Beira Mar, Aracaju - SE",lat:-10.91,lng:-37.05,shelteredCount:110,services:["Acolhimento e Reagrupamento"],website:"https://adotaaracaju.org"},{id:"ong-to-1",name:"SOS Animais Palmas",city:"Palmas",state:"TO",phone:"(63) 99211-4455",whatsapp:"5563992114455",instagram:"sosanimaispalmas",address:"Plano Diretor Sul, Palmas - TO",lat:-10.24,lng:-48.33,shelteredCount:105,services:["Resgate no Tocantins","Triagem de Perda"],website:"https://sosanimaispalmas.org"}];class te{constructor(){this.pets=[],this.ongs=ee,this.init()}init(){const r=localStorage.getItem(V);if(r)try{this.pets=JSON.parse(r)}catch{this.pets=_}else this.pets=_,this.save()}save(){localStorage.setItem(V,JSON.stringify(this.pets))}getPets(r={}){return this.pets.filter(o=>{if(r.status&&o.status!==r.status||r.type&&r.type!=="all"&&o.type!==r.type||r.city&&r.city!=="all"&&o.city.toLowerCase()!==r.city.toLowerCase())return!1;if(r.query){const e=r.query.toLowerCase();if(!(o.name.toLowerCase().includes(e)||o.breed.toLowerCase().includes(e)||o.neighborhood.toLowerCase().includes(e)||o.city.toLowerCase().includes(e)||o.description.toLowerCase().includes(e)))return!1}return!0})}getPetById(r){return this.pets.find(o=>o.id===r)}addPet(r){const o={id:"pet-"+Date.now(),date:new Date().toLocaleDateString("pt-BR"),time:new Date().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),urgent:!0,...r};return this.pets.unshift(o),this.save(),o}getStates(){return[...new Set(this.ongs.map(r=>r.state))].sort()}getCitiesByState(r){return!r||r==="all"?[...new Set(this.ongs.map(o=>o.city))].sort():[...new Set(this.ongs.filter(o=>o.state===r).map(o=>o.city))].sort()}getOngs(r="all",o="all",e=""){return this.ongs.filter(a=>{if(r!=="all"&&a.state.toLowerCase()!==r.toLowerCase()||o!=="all"&&a.city.toLowerCase()!==o.toLowerCase())return!1;if(e.trim()!==""){const s=e.toLowerCase();if(!(a.name.toLowerCase().includes(s)||a.city.toLowerCase().includes(s)||a.state.toLowerCase().includes(s)||a.address.toLowerCase().includes(s)||a.instagram&&a.instagram.toLowerCase().includes(s)))return!1}return!0})}getStats(){const r=this.pets.filter(a=>a.status==="lost").length,o=this.pets.filter(a=>a.status==="found").length,e=2450+o;return{totalLost:r,totalFound:o,reunited:e}}}const A=new te;function W(t,r,o){var e;const a=A.getStats(),s=A.getPets({status:"lost"}).slice(0,4),m=A.getPets({status:"found"}).slice(0,3);t.innerHTML=`
        ...
        <div class="lg:col-span-7 flex flex-col gap-6">
          ...
          <div class="grid grid-cols-3 gap-4 pt-6 border-t border-outline-variant/30 text-on-surface-variant max-w-lg">
            <div class="flex flex-col">
              <span class="text-2xl sm:text-3xl font-extrabold text-on-surface">${a.reunited}+</span>
            ...
            <div class="flex flex-col">
              <span class="text-2xl sm:text-3xl font-extrabold text-primary">${a.totalLost}</span>
  ...
  `;let c="lost";const x=t.querySelector("#qs-btn-lost"),f=t.querySelector("#qs-btn-found");x==null||x.addEventListener("click",()=>{c="lost",x.className="qs-type-btn py-2 text-xs font-bold rounded-lg bg-primary-container text-on-primary-container shadow-sm transition-all",f.className="qs-type-btn py-2 text-xs font-bold rounded-lg text-on-surface-variant hover:text-on-surface transition-all"}),f==null||f.addEventListener("click",()=>{c="found",f.className="qs-type-btn py-2 text-xs font-bold rounded-lg bg-secondary-container text-on-secondary-container shadow-sm transition-all",x.className="qs-type-btn py-2 text-xs font-bold rounded-lg text-on-surface-variant hover:text-on-surface transition-all"}),(e=t.querySelector("#quick-search-form"))==null||e.addEventListener("submit",i=>{i.preventDefault();const l=t.querySelector("#qs-type").value,g=t.querySelector("#qs-location").value;window.location.hash=`#/mapa?status=${c}&type=${l}&q=${encodeURIComponent(g)}`}),t.querySelectorAll(".pet-card-clickable").forEach(i=>{i.addEventListener("click",()=>{const l=i.getAttribute("data-id");o(l)})})}function H(t){const r=t.status==="lost",o=r?"bg-primary-container text-on-primary-container":"bg-secondary-container text-on-secondary-container",e=r?"PERDIDO":"AVISTADO";return`
    <div data-id="${t.id}" class="pet-card-clickable group bg-surface-container border border-surface-container-highest rounded-2xl overflow-hidden hover:border-primary/50 transition-all duration-300 shadow-md hover:shadow-xl cursor-pointer flex flex-col">
      <!-- Image & Badges -->
      <div class="relative h-48 sm:h-52 w-full overflow-hidden bg-surface-container-high">
        <img src="${t.photo}" alt="${t.name}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
        <div class="absolute top-3 left-3 flex gap-2">
          <span class="text-[10px] font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-full ${o} shadow-sm">
            ${e}
          </span>
          ${t.reward&&t.reward!=="Sem recompensa"&&t.reward!=="N/A"?`
            <span class="text-[10px] font-extrabold px-2.5 py-1 rounded-full bg-emerald-500/90 text-white shadow-sm flex items-center gap-1">
              <span class="material-symbols-outlined text-xs">payments</span> ${t.reward}
            </span>
          `:""}
        </div>
      ...
      <div class="p-4 flex-grow flex flex-col justify-between space-y-3">
        <div>
          <div class="flex justify-between items-start mb-1">
            <h3 class="font-bold text-base text-on-surface group-hover:text-primary transition-colors">${t.name}</h3>
            <span class="text-xs text-on-surface-variant font-medium">${t.breed}</span>
          </div>

          <p class="text-xs text-on-surface-variant flex items-center gap-1 font-medium">
            <span class="material-symbols-outlined text-primary text-sm">location_on</span>
            <span>${t.neighborhood}, ${t.city}</span>
          </p>
        ...
        <div class="pt-3 border-t border-outline-variant/20 flex justify-between items-center text-xs">
          <span class="text-on-surface-variant font-medium">Tutor: ${t.contactName}</span>
  ...
  `}const E=window.L;function ae(t,r,o){const e=new URLSearchParams(window.location.hash.split("?")[1]);let a=e.get("status")||"all",s=e.get("type")||"all";e.get("city");let m=e.get("q")||"",c="split";t.innerHTML=`
          ...
          <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
            ...
            <div class="md:col-span-3">
              <div class="grid grid-cols-3 gap-1 p-1 bg-surface-container-low rounded-xl border border-outline-variant/30 text-[11px] font-bold">
                <button class="status-btn py-1.5 rounded-lg text-center transition-all ${a==="all"?"bg-primary-container text-on-primary-container shadow-sm":"text-on-surface-variant hover:text-on-surface"}" data-status="all">Todos</button>
                <button class="status-btn py-1.5 rounded-lg text-center transition-all ${a==="lost"?"bg-primary-container text-on-primary-container shadow-sm":"text-on-surface-variant hover:text-on-surface"}" data-status="lost">Perdidos</button>
                <button class="status-btn py-1.5 rounded-lg text-center transition-all ${a==="found"?"bg-secondary-container text-on-secondary-container shadow-sm":"text-on-surface-variant hover:text-on-surface"}" data-status="found">Avistados</button>
              </div>
            </div>
            ...
            <div class="md:col-span-2">
              <select id="unified-species" class="w-full bg-surface-container-high border border-outline-variant rounded-xl py-2 px-2.5 text-xs text-on-surface focus:outline-none focus:border-primary">
                <option value="all" ${s==="all"?"selected":""}>Todas Espécies</option>
                <option value="dog" ${s==="dog"?"selected":""}>Cães</option>
                <option value="cat" ${s==="cat"?"selected":""}>Gatos</option>
              </select>
            </div>
  ...
  `;const x=t.querySelector("#leaflet-unified-map"),f=E.map(x).setView([-23.5587,-46.6853],12);E.tileLayer("https://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}",{maxZoom:20,subdomains:["mt0","mt1","mt2","mt3"],attribution:"&copy; Google Maps"}).addTo(f);let i=E.layerGroup().addTo(f);function l(){const p=t.querySelector("#map-wrapper"),u=t.querySelector("#grid-wrapper");c==="split"?(p.className="w-full lg:w-1/2 h-[450px] lg:h-auto rounded-3xl overflow-hidden border border-surface-container-highest shadow-2xl relative",u.className="w-full lg:w-1/2 flex flex-col space-y-4 overflow-y-auto max-h-[700px] pr-1",p.style.display="block",u.style.display="flex"):c==="map"?(p.className="w-full h-[650px] rounded-3xl overflow-hidden border border-surface-container-highest shadow-2xl relative",u.style.display="none",p.style.display="block"):c==="grid"&&(u.className="w-full flex flex-col space-y-4",u.querySelector("#unified-pets-grid").className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6",p.style.display="none",u.style.display="flex"),setTimeout(()=>{f.invalidateSize()},100)}function g(){i.clearLayers(),m=t.querySelector("#unified-search").value;const p={status:a==="all"?null:a,type:s,query:m},u=A.getPets(p),v=A.getOngs("all","all",m),h=t.querySelector("#pets-counter");h.textContent=`${u.length} Pets Alertas & ${v.length} ONGs Mapeadas`;const y=t.querySelector("#unified-pets-grid");u.length===0?y.innerHTML=`
      ...
      `:y.innerHTML=u.map(n=>{const b=n.status==="lost";return`
          <div data-id="${n.id}" class="pet-unified-card group bg-surface-container border border-surface-container-highest hover:border-primary/60 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col justify-between">
            <div class="relative h-44 w-full overflow-hidden bg-surface-container-high">
              <img src="${n.photo}" alt="${n.name}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
              <div class="absolute top-2.5 left-2.5 flex flex-wrap gap-1.5">
                <span class="text-[10px] font-extrabold uppercase px-2.5 py-0.5 rounded-full ${b?"bg-primary-container text-on-primary-container":"bg-secondary-container text-on-secondary-container"} shadow-sm">
                  ${b?"PERDIDO":"AVISTADO"}
                </span>
                ${n.reward&&n.reward!=="Sem recompensa"&&n.reward!=="N/A"?`
                  <span class="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-emerald-500 text-white shadow-sm flex items-center gap-1">
                    <span class="material-symbols-outlined text-[12px]">payments</span> ${n.reward}
                  </span>
                `:""}
              </div>
            ...
            <div class="p-4 flex-grow flex flex-col justify-between space-y-2.5">
              <div>
                <div class="flex justify-between items-start">
                  <h3 class="font-bold text-base text-on-surface group-hover:text-primary transition-colors">${n.name}</h3>
                  <span class="text-[11px] text-on-surface-variant font-medium bg-surface-container-high px-2 py-0.5 rounded-md border border-outline-variant/30">${n.breed}</span>
                </div>
              ...
              <div class="pt-2 border-t border-outline-variant/20 flex gap-2">
                <button class="btn-focus-map flex-1 bg-surface-container-high hover:bg-surface-container-highest text-on-surface font-bold text-[11px] py-1.5 rounded-lg border border-outline-variant/40 transition-all flex items-center justify-center gap-1" data-id="${n.id}" data-lat="${n.lat}" data-lng="${n.lng}">
                  <span class="material-symbols-outlined text-xs text-primary">pin_drop</span>
                  <span>Ver no Mapa</span>
                </button>
                <button class="btn-view-details flex-1 bg-primary-container hover:bg-primary-container/90 text-on-primary-container font-bold text-[11px] py-1.5 rounded-lg transition-all flex items-center justify-center gap-1" data-id="${n.id}">
        ...
        `}).join("");const w={},C=[];u.forEach(n=>{const b=n.status==="lost",S=b?"#ff8833":"#c8c4db",R=E.divIcon({className:"custom-leaflet-pin",html:`
        ...
        `,iconSize:[34,34],iconAnchor:[17,17]}),P=E.marker([n.lat,n.lng],{icon:R}).addTo(i);C.push([n.lat,n.lng]),w[n.id]={marker:P,pet:n};const q=`
        <div class="p-1 space-y-2 max-w-xs font-sans text-white">
          <div class="flex items-center gap-2">
            <span class="text-[10px] font-bold uppercase px-2 py-0.5 rounded-full ${b?"bg-primary-container text-on-primary-container":"bg-secondary-container text-on-secondary-container"}">
              ${b?"Perdido (Última vez visto)":"Avistado (Localizado)"}
            </span>
            <span class="text-xs font-bold text-white">${n.name}</span>
          </div>
          <p class="text-xs text-gray-300"><strong>Endereço / Região:</strong> ${n.location||n.neighborhood+", "+n.city}</p>
          <p class="text-xs text-gray-300"><strong>Data:</strong> ${n.date} às ${n.time}</p>
          <button class="open-modal-from-map bg-primary hover:bg-primary/90 text-on-primary text-xs font-bold py-1.5 px-3 rounded-lg w-full mt-2" data-id="${n.id}">
            Ver detalhes no card
          </button>
        </div>
      `;P.bindPopup(q),P.on("click",()=>{f.setView([n.lat,n.lng],16,{animate:!0}),o(n.id)})});function L(n){const b=w[n];if(c==="grid"&&(c="split",d(),l()),b){f.setView([b.pet.lat,b.pet.lng],16,{animate:!0}),b.marker.openPopup();const S=t.querySelector("#map-wrapper");window.innerWidth<1024&&(S==null||S.scrollIntoView({behavior:"smooth",block:"nearest"}))}o(n)}y.querySelectorAll(".btn-focus-map, .btn-view-details, .pet-unified-card").forEach(n=>{n.addEventListener("click",b=>{const S=n.getAttribute("data-id");L(S)})}),f.on("popupopen",n=>{const b=n.popup._contentNode.querySelector(".open-modal-from-map");b&&b.addEventListener("click",()=>{o(b.getAttribute("data-id"))})}),C.length>0&&setTimeout(()=>{f.fitBounds(C,{padding:[40,40],maxZoom:13})},100)}t.querySelectorAll(".status-btn").forEach(p=>{p.addEventListener("click",()=>{a=p.getAttribute("data-status"),t.querySelectorAll(".status-btn").forEach(u=>{u.className="status-btn py-1.5 rounded-lg text-center transition-all text-on-surface-variant hover:text-on-surface"}),p.className=`status-btn py-1.5 rounded-lg text-center transition-all ${a==="found"?"bg-secondary-container text-on-secondary-container shadow-sm":"bg-primary-container text-on-primary-container shadow-sm"}`,g()})}),t.querySelector("#unified-species").addEventListener("change",p=>{s=p.target.value,g()}),t.querySelector("#unified-search").addEventListener("input",()=>{g()}),t.querySelector("#view-split-btn").addEventListener("click",()=>{c="split",d(),l()}),t.querySelector("#view-map-btn").addEventListener("click",()=>{c="map",d(),l()}),t.querySelector("#view-grid-btn").addEventListener("click",()=>{c="grid",d(),l()});function d(){t.querySelectorAll(".view-toggle-btn").forEach(p=>{p.className="view-toggle-btn px-3 py-1.5 rounded-lg flex items-center gap-1 transition-all text-on-surface-variant"}),c==="split"?t.querySelector("#view-split-btn").className="view-toggle-btn px-3 py-1.5 rounded-lg flex items-center gap-1 transition-all bg-surface-container-high text-primary shadow-sm font-bold":c==="map"?t.querySelector("#view-map-btn").className="view-toggle-btn px-3 py-1.5 rounded-lg flex items-center gap-1 transition-all bg-surface-container-high text-primary shadow-sm font-bold":c==="grid"&&(t.querySelector("#view-grid-btn").className="view-toggle-btn px-3 py-1.5 rounded-lg flex items-center gap-1 transition-all bg-surface-container-high text-primary shadow-sm font-bold")}l(),g()}function oe(t,r){var o,e,a,s,m;const c=new URLSearchParams(window.location.hash.split("?")[1]).get("status")==="found"?"found":"lost";t.innerHTML=`
  ...
  `;let x=1;const f=t.querySelector("#form-step-1"),i=t.querySelector("#form-step-2"),l=t.querySelector("#form-step-3"),g=t.querySelector("#step-pill-1"),d=t.querySelector("#step-pill-2"),p=t.querySelector("#step-pill-3");function u(){f.classList.add("hidden"),i.classList.add("hidden"),l.classList.add("hidden"),g.classList.add("opacity-50"),d.classList.add("opacity-50"),p.classList.add("opacity-50"),x===1?(f.classList.remove("hidden"),g.classList.remove("opacity-50")):x===2?(i.classList.remove("hidden"),d.classList.remove("opacity-50")):x===3&&(l.classList.remove("hidden"),p.classList.remove("opacity-50"))}(o=t.querySelector("#btn-next-1"))==null||o.addEventListener("click",()=>{x=2,u()}),(e=t.querySelector("#btn-next-2"))==null||e.addEventListener("click",()=>{x=3,u()}),(a=t.querySelector("#btn-back-2"))==null||a.addEventListener("click",()=>{x=1,u()}),(s=t.querySelector("#btn-back-3"))==null||s.addEventListener("click",()=>{x=2,u()});const v=()=>{var h,y,w,C,L,n,b,S,R,P;const q=((h=t.querySelector('input[name="status"]:checked'))==null?void 0:h.value)||"lost",j=((y=t.querySelector("#input-name"))==null?void 0:y.value)||"Nome do Pet",O=((w=t.querySelector("#input-breed"))==null?void 0:w.value)||"Raça",B=((C=t.querySelector("#input-photo"))==null?void 0:C.value)||"https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=800&q=80",z=((L=t.querySelector("#input-description"))==null?void 0:L.value)||"",G=((n=t.querySelector("#input-city"))==null?void 0:n.value)||"São Paulo",I=((b=t.querySelector("#input-neighborhood"))==null?void 0:b.value)||"Bairro",F=((S=t.querySelector("#input-reward"))==null?void 0:S.value)||"Sem recompensa",X=((R=t.querySelector("#input-contact-name"))==null?void 0:R.value)||"Seu Nome",Y=((P=t.querySelector("#input-contact-phone"))==null?void 0:P.value)||"",N=t.querySelector("#prev-badge");q==="lost"?(N.textContent="PERDIDO",N.className="text-[10px] font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-full bg-primary-container text-on-primary-container shadow-md"):(N.textContent="ENCONTRADO",N.className="text-[10px] font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-full bg-secondary-container text-on-secondary-container shadow-md"),t.querySelector("#prev-name").textContent=j,t.querySelector("#prev-breed").textContent=O,t.querySelector("#prev-img").src=B,t.querySelector("#prev-desc").textContent=z,t.querySelector("#prev-loc").innerHTML=`<span class="material-symbols-outlined text-primary text-sm">location_on</span> ${I}, ${G}`,t.querySelector("#prev-reward").textContent=F,t.querySelector("#prev-contact").textContent=X,t.querySelector("#prev-phone").textContent=Y};t.querySelectorAll("input, select, textarea").forEach(h=>{h.addEventListener("input",v),h.addEventListener("change",v)}),(m=t.querySelector("#register-pet-form"))==null||m.addEventListener("submit",h=>{var y;h.preventDefault();const w=((y=t.querySelector('input[name="status"]:checked'))==null?void 0:y.value)||"lost",C=t.querySelector("#input-name").value,L=t.querySelector("#input-type").value,n=t.querySelector("#input-breed").value,b=t.querySelector("#input-color").value,S=t.querySelector("#input-photo").value,R=t.querySelector("#input-description").value,P=t.querySelector("#input-city").value,q=t.querySelector("#input-neighborhood").value,j=t.querySelector("#input-location").value,O=t.querySelector("#input-reward").value,B=t.querySelector("#input-contact-name").value,z=t.querySelector("#input-contact-phone").value,G=t.querySelector("#input-microchip").value,I=-23.5505+(Math.random()-.5)*.1,F=-46.6333+(Math.random()-.5)*.1;A.addPet({name:C,type:L,breed:n,color:b,photo:S,description:R,city:P,state:"SP",neighborhood:q,location:j,reward:O,contactName:B,contactPhone:z,microchip:G,status:w,lat:I,lng:F}),r(`Alerta de ${C} cadastrado com sucesso!`,"success"),window.location.hash=w==="lost"?"#/pets-perdidos":"#/pets-encontrados"})}const M=window.L;function se(t,r){const o=A.getStates();t.innerHTML=`
          ...
          <div class="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
            ...
            <div class="sm:col-span-3">
              <select id="ong-state-select" class="w-full bg-surface-container-high border border-outline-variant rounded-xl py-2.5 px-3 text-sm text-on-surface focus:outline-none focus:border-primary">
                ...
                ${o.map(i=>`<option value="${i}">${i}</option>`).join("")}
              </select>
            </div>
  ...
  `;let e="all",a="all",s="";const m=M.map(t.querySelector("#ong-leaflet-map")).setView([-14.235,-51.9253],4);M.tileLayer("https://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}",{maxZoom:20,subdomains:["mt0","mt1","mt2","mt3"],attribution:"&copy; Google Maps"}).addTo(m);let c=M.layerGroup().addTo(m);function x(i=!1){const l=t.querySelector("#ong-city-select");if(l)if(e==="all")l.disabled=!0,l.innerHTML='<option value="all">Selecione um Estado primeiro...</option>',l.classList.add("opacity-60","cursor-not-allowed"),a="all";else{l.disabled=!1,l.classList.remove("opacity-60","cursor-not-allowed");const g=A.getCitiesByState(e);if(l.innerHTML='<option value="all">Todas as Cidades de '+e+"</option>"+g.map(d=>`<option value="${d}">${d}</option>`).join(""),a="all",i&&(l.focus(),typeof l.showPicker=="function"))try{l.showPicker()}catch{}}}function f(){c.clearLayers();const i=A.getOngs(e,a,s);t.querySelector("#ong-grid-counter").textContent=`${i.length} ONGs listadas`,t.querySelector("#map-ong-count").textContent=`${i.length} no mapa`;const l=t.querySelector("#ongs-grid");if(i.length===0){l.innerHTML=`
      ...
      `;return}l.innerHTML=i.map(d=>re(d)).join("");const g=[];i.forEach(d=>{const p=M.divIcon({className:"custom-leaflet-ong-pin",html:`
        ...
        `,iconSize:[34,34],iconAnchor:[17,17]}),u=M.marker([d.lat,d.lng],{icon:p}).addTo(c);g.push([d.lat,d.lng]);const v=`
        <div class="p-1 space-y-2 max-w-xs font-sans text-white">
      ...
      `;u.bindPopup(v)}),g.length>0&&setTimeout(()=>{m.fitBounds(g,{padding:[40,40],maxZoom:13})},100)}t.querySelector("#ong-state-select").addEventListener("change",i=>{e=i.target.value,x(!0),f()}),t.querySelector("#ong-city-select").addEventListener("change",i=>{a=i.target.value,f()}),t.querySelector("#ong-search").addEventListener("input",i=>{s=i.target.value,f()}),x(),f()}function re(t){return`
    <div class="bg-surface-container border border-surface-container-highest rounded-2xl p-6 shadow-xl flex flex-col justify-between space-y-4 hover:border-tertiary/40 transition-all">
      <div class="space-y-3">
        <div class="flex items-start justify-between">
          <div>
            ...
            <h3 class="font-bold text-lg text-on-surface mt-2 leading-tight">${t.name}</h3>
          </div>
          <div class="text-right bg-surface-container-high px-2.5 py-1 rounded-xl border border-outline-variant/30 flex-shrink-0">
            <span class="text-base font-extrabold text-primary">${t.shelteredCount}</span>
      ...
      <div class="pt-4 border-t border-outline-variant/20 flex flex-col gap-2">
        <div class="flex gap-2">
          <a href="tel:${t.phone.replace(/\D/g,"")}" class="flex-1 bg-surface-container-high hover:bg-surface-variant text-on-surface font-bold text-xs py-2 px-2 rounded-xl border border-outline-variant/40 flex items-center justify-center gap-1 transition-all">
            <span class="material-symbols-outlined text-sm">call</span>
            <span>${t.phone}</span>
          </a>
          <a href="https://wa.me/${t.whatsapp}?text=Olá!%20Encontrei%20a%20ONG%20no%20Faro%20e%20gostaria%20de%20ajuda." target="_blank" class="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs py-2 px-2 rounded-xl flex items-center justify-center gap-1 transition-all shadow-sm">
        ...
        <div class="flex gap-2">
          ${t.instagram?`
            <a href="https://instagram.com/${t.instagram}" target="_blank" class="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:opacity-90 text-white font-bold text-xs py-2 px-2 rounded-xl flex items-center justify-center gap-1 transition-all shadow-sm">
              <span class="material-symbols-outlined text-sm">photo_camera</span>
              <span>@${t.instagram}</span>
            </a>
          `:""}
          ${t.website?`
            <a href="${t.website}" target="_blank" class="flex-1 bg-surface-container-high hover:bg-surface-variant text-primary font-bold text-xs py-2 px-2 rounded-xl border border-primary/30 flex items-center justify-center gap-1 transition-all">
  ...
  `,s=t.querySelector("#guide-content");s.innerHTML=o;const m=t.querySelector("#guide-tab-dogs"),c=t.querySelector("#guide-tab-cats"),x=t.querySelector("#guide-tab-poster");m.addEventListener("click",()=>{m.className="px-6 py-3 rounded-xl font-bold text-sm bg-primary-container text-on-primary-container shadow-md transition-all flex items-center gap-2.5",c.className="px-6 py-3 rounded-xl font-bold text-sm text-on-surface-variant hover:text-on-surface transition-all flex items-center gap-2.5",x.className="px-6 py-3 rounded-xl font-bold text-sm text-on-surface-variant hover:text-on-surface transition-all flex items-center gap-2.5",s.innerHTML=o}),c.addEventListener("click",()=>{c.className="px-6 py-3 rounded-xl font-bold text-sm bg-secondary-container text-on-secondary-container shadow-md transition-all flex items-center gap-2.5",m.className="px-6 py-3 rounded-xl font-bold text-sm text-on-surface-variant hover:text-on-surface transition-all flex items-center gap-2.5",x.className="px-6 py-3 rounded-xl font-bold text-sm text-on-surface-variant hover:text-on-surface transition-all flex items-center gap-2.5",s.innerHTML=e,f()}),x.addEventListener("click",()=>{x.className="px-6 py-3 rounded-xl font-bold text-sm bg-tertiary-container text-on-tertiary-container shadow-md transition-all flex items-center gap-2.5",m.className="px-6 py-3 rounded-xl font-bold text-sm text-on-surface-variant hover:text-on-surface transition-all flex items-center gap-2.5",c.className="px-6 py-3 rounded-xl font-bold text-sm text-on-surface-variant hover:text-on-surface transition-all flex items-center gap-2.5",s.innerHTML=a,i()});function f(){var l,g,d;const p=u=>{r(`Tocando som atrativo felino: ${u}`,"info");try{const v=new(window.AudioContext||window.webkitAudioContext),h=v.createOscillator(),y=v.createGain();h.type="sine",h.frequency.setValueAtTime(u==="meow"?650:350,v.currentTime),h.frequency.exponentialRampToValueAtTime(u==="meow"?450:700,v.currentTime+.6),y.gain.setValueAtTime(.3,v.currentTime),y.gain.exponentialRampToValueAtTime(.01,v.currentTime+.6),h.connect(y),y.connect(v.destination),h.start(),h.stop(v.currentTime+.6)}catch{}};(l=t.querySelector("#play-sound-meow"))==null||l.addEventListener("click",()=>p("meow")),(g=t.querySelector("#play-sound-food"))==null||g.addEventListener("click",()=>p("food")),(d=t.querySelector("#play-sound-purr"))==null||d.addEventListener("click",()=>p("purr"))}function i(){var l;const g=t.querySelector("#poster-title"),d=t.querySelector("#poster-name"),p=t.querySelector("#poster-reward"),u=t.querySelector("#poster-phone"),v=t.querySelector("#poster-loc"),h=t.querySelector("#poster-photo"),y=()=>{t.querySelector("#p-render-title").textContent=g.value,t.querySelector("#p-render-name").textContent=d.value,t.querySelector("#p-render-reward").textContent=p.value,t.querySelector("#p-render-phone").textContent=u.value,t.querySelector("#p-render-loc").textContent=v.value,t.querySelector("#p-render-img").src=h.value};[g,d,p,u,v,h].forEach(w=>{w==null||w.addEventListener("input",y)}),(l=t.querySelector("#btn-print-poster"))==null||l.addEventListener("click",()=>{window.print()})}}function ie(t){const r=[{id:"art-1",title:"Caminhos de Cheiro: Uma Estratégia Afetiva para Reencontrar Seu Cachorro",category:"Táticas de Busca",date:"05 de Agosto de 2026",readTime:"4 min de leitura",image:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=800&q=80",summary:"Entenda como utilizar peças de vestuário usadas do tutor para criar rastros olfativos radiais que orientam o cão de volta à sua residência.",content:`
            ...
            <article class="bg-surface-container border border-surface-container-highest rounded-3xl overflow-hidden shadow-xl hover:border-primary/40 transition-all flex flex-col justify-between">
              <div>
                <div class="h-48 w-full overflow-hidden bg-surface-container-high relative">
                  <img src="${o.image}" alt="${o.title}" class="w-full h-full object-cover">
                ...
                <div class="p-6 space-y-3">
                  ...
                  <h3 class="font-bold text-lg text-on-surface leading-snug">${o.title}</h3>
                  <p class="text-xs text-on-surface-variant leading-relaxed line-clamp-3">${o.summary}</p>
                </div>
              </div>

              <div class="p-6 pt-0">
                <button class="read-article-btn w-full bg-surface-container-high hover:bg-surface-variant text-primary font-bold text-xs py-3 rounded-xl border border-outline-variant/30 flex items-center justify-center gap-1.5 transition-all" data-id="${o.id}">
  ...
  `,t.querySelectorAll(".read-article-btn").forEach(o=>{o.addEventListener("click",()=>{const e=r.find(s=>s.id===o.getAttribute("data-id"));if(!e)return;const a=document.createElement("div");a.className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto",a.innerHTML=`
        <div class="bg-surface-container border border-surface-container-highest rounded-3xl max-w-2xl w-full p-6 sm:p-8 space-y-4 relative my-8 shadow-2xl">
          ...
          <span class="text-xs font-bold uppercase text-primary">${e.category} • ${e.readTime}</span>
          <h2 class="text-2xl font-extrabold text-on-surface">${e.title}</h2>
          <div class="text-sm text-on-surface leading-relaxed border-t border-outline-variant/20 pt-4">
            ${e.content}
          </div>
        </div>
      `,document.body.appendChild(a),a.querySelector("#close-art-modal").addEventListener("click",()=>a.remove()),a.addEventListener("click",s=>{s.target===a&&a.remove()})})})}function le(t,r){var o;t.innerHTML=`
    <div class="py-12 bg-background flex-grow">
  ...
  `,(o=t.querySelector("#contact-form"))==null||o.addEventListener("submit",e=>{e.preventDefault(),r("Mensagem enviada com sucesso! Nossa equipe responderá em breve.","success"),t.querySelector("#contact-form").reset()})}function de(t,r){var o;t.innerHTML=`
    <div class="py-10 bg-background flex-grow">
  ...
  `,(o=t.querySelector("#btn-copy-pix"))==null||o.addEventListener("click",()=>{const e=t.querySelector("#pix-key-input");navigator.clipboard.writeText(e.value),r("Chave PIX copiada para a área de transferência!","success")})}const ce=document.getElementById("app"),pe=document.getElementById("toast-container"),$=document.getElementById("emergency-modal"),U=document.getElementById("btn-emergency"),J=document.getElementById("close-emergency-modal"),K=document.getElementById("mobile-menu-toggle"),T=document.getElementById("mobile-menu"),Q=document.getElementById("theme-toggle"),k=document.getElementById("theme-icon");function ue(){(localStorage.getItem("faro_theme")||"dark")==="dark"?(document.documentElement.classList.add("dark"),k&&(k.textContent="light_mode")):(document.documentElement.classList.remove("dark"),k&&(k.textContent="dark_mode"))}Q==null||Q.addEventListener("click",()=>{document.documentElement.classList.contains("dark")?(document.documentElement.classList.remove("dark"),localStorage.setItem("faro_theme","light"),k&&(k.textContent="dark_mode"),D("Modo Claro ativado (Design System Quicksand/Inter)","info")):(document.documentElement.classList.add("dark"),localStorage.setItem("faro_theme","dark"),k&&(k.textContent="light_mode"),D("Modo Escuro ativado (Design System Dark Faro)","info"))});const me={"/":W,"/mapa":ae,"/cadastrar":oe,"/pets-perdidos":(t,r,o)=>{window.location.hash="#/mapa?status=lost"},"/pets-encontrados":(t,r,o)=>{window.location.hash="#/mapa?status=found"},"/ongs":se,"/guia":ne,"/ajudar":de,"/informativos":ie,"/fale-conosco":le};function Z(){const t=(window.location.hash||"#/").split("?")[0].replace("#","")||"/";document.querySelectorAll(".nav-link, .mobile-nav-link").forEach(o=>{o.getAttribute("data-route")===t?(o.classList.add("text-primary","font-bold"),o.classList.remove("text-on-surface-variant")):(o.classList.remove("text-primary","font-bold"),o.classList.add("text-on-surface-variant"))}),T==null||T.classList.add("hidden");const r=me[t]||W;window.scrollTo({top:0,behavior:"smooth"}),r(ce,D,xe)}window.addEventListener("hashchange",Z);window.addEventListener("DOMContentLoaded",()=>{ue(),Z()});K==null||K.addEventListener("click",()=>{T==null||T.classList.toggle("hidden")});U==null||U.addEventListener("click",()=>{$==null||$.classList.remove("hidden")});J==null||J.addEventListener("click",()=>{$==null||$.classList.add("hidden")});function D(t,r="info"){const o=document.createElement("div"),e=r==="success"?"bg-emerald-600 text-white":"bg-surface-container-high border border-primary/40 text-on-surface";o.className=`toast-enter pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl ${e} text-xs font-bold max-w-sm`,o.innerHTML=`
    <span class="material-symbols-outlined text-base">${r==="success"?"check_circle":"info"}</span>
    <span>${t}</span>
  `,pe.appendChild(o),setTimeout(()=>{o.remove()},4e3)}function xe(t){var r;const o=A.getPetById(t);if(!o)return;document.querySelectorAll(".floating-pet-detail-card").forEach(m=>m.remove());const e=document.createElement("div");e.className="floating-pet-detail-card fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 max-w-lg w-[calc(100%-2rem)] sm:w-full max-h-[82vh] overflow-y-auto bg-surface-container/95 border border-surface-container-highest rounded-3xl shadow-2xl backdrop-blur-xl animate-fade-in p-5 space-y-4";const a=o.status==="lost",s=a?"bg-primary-container text-on-primary-container":"bg-secondary-container text-on-secondary-container";e.innerHTML=`
    <div class="flex justify-between items-center border-b border-surface-container-highest pb-3">
      <div class="flex items-center gap-2">
        <span class="text-[10px] font-extrabold uppercase px-2.5 py-0.5 rounded-full ${s} shadow-sm">
          ${a?"PERDIDO":"AVISTADO"}
        </span>
        ${o.reward&&o.reward!=="Sem recompensa"&&o.reward!=="N/A"?`
          <span class="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-emerald-500 text-white shadow-sm flex items-center gap-1">
            <span class="material-symbols-outlined text-xs">payments</span> ${o.reward}
          </span>
        `:""}
      </div>
    ...
    <div class="flex gap-4 items-start">
      <img src="${o.photo}" alt="${o.name}" class="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl object-cover flex-shrink-0 border border-outline-variant/30 shadow-md">
      <div class="space-y-1 flex-grow">
        <h2 class="text-xl font-extrabold text-on-surface leading-tight">${o.name}</h2>
        <p class="text-xs text-on-surface-variant font-medium">${o.breed} • ${o.gender} • ${o.color}</p>
        <div class="text-[11px] text-on-surface-variant flex items-center gap-1 pt-1">
          ...
          <span>${o.neighborhood}, ${o.city} (${o.state})</span>
        </div>
    ...
    <div class="grid grid-cols-2 gap-2 text-[11px] bg-surface-container-high p-3 rounded-xl border border-outline-variant/30">
      <div><span class="text-on-surface-variant">Responsável:</span> <strong class="block text-on-surface text-xs mt-0.5">${o.contactName}</strong></div>
      <div><span class="text-on-surface-variant">Microchip:</span> <strong class="block text-on-surface text-xs mt-0.5">${o.microchip||"Não informado"}</strong></div>
    </div>

    <div class="pt-1 flex gap-2">
      <a href="tel:${o.contactPhone.replace(/\D/g,"")}" class="flex-1 bg-primary-container hover:bg-primary-container/90 text-on-primary-container font-extrabold text-xs py-2.5 px-3 rounded-xl flex items-center justify-center gap-1.5 shadow-md transition-all">
        <span class="material-symbols-outlined text-sm">call</span>
        <span>Ligar</span>
      </a>
      <a href="https://wa.me/55${o.contactPhone.replace(/\D/g,"")}?text=Olá%20${encodeURIComponent(o.contactName)},%20vi%20o%20alerta%20do%20pet%20${encodeURIComponent(o.name)}%20no%20Faro!" target="_blank" class="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs py-2.5 px-3 rounded-xl flex items-center justify-center gap-1.5 shadow-md transition-all">
        <span class="material-symbols-outlined text-sm">chat</span>
        <span>WhatsApp</span>
      </a>
    </div>
  `,document.body.appendChild(e),(r=e.querySelector("#close-pet-card"))==null||r.addEventListener("click",()=>{e.remove()})}
