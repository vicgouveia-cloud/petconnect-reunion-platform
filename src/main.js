...
const routes = {
  ...
  '/guia/caes': (container, showToast) => renderReunionGuideView(container, showToast, 'dogs'),
  '/guia/gatos': (container, showToast) => renderReunionGuideView(container, showToast, 'cats'),
  '/achar-cachorro-desaparecido': (container, showToast) => renderReunionGuideView(container, showToast, 'dogs'),
  '/encontrar-gato-perdido': (container, showToast) => renderReunionGuideView(container, showToast, 'cats'),
  '/instrucoes-para-recuperacao': (container, showToast) => renderReunionGuideView(container, showToast, 'general'),
